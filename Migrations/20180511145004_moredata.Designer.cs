...
namespace PublicationsTracker.Migrations
{
    ...
    [Migration("20180511145004_moredata")]
            ...
            modelBuilder.Entity("Publications.Article", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ArticleId = 3, AuthorId = 2, MagazineId = 2, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Reddit and the Struggle to Detoxify the Internet" },
                        new { ArticleId = 4, AuthorId = 3, MagazineId = 2, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Digital Vigilantes" }
                    );
                });
            ...
            modelBuilder.Entity("Publications.Author", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { AuthorId = 3, Name = "Nicholas Schmidle" }
                    );
                });
